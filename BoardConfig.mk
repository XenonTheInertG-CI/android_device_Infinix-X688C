...
DEVICE_PATH := device/infinix/Infinix-X688C
...
# Assert
TARGET_OTA_ASSERT_DEVICE := Infinix-X688C
...
TARGET_KERNEL_SOURCE := kernel/infinix/Infinix-X688C
TARGET_KERNEL_CONFIG := Infinix-X688C_defconfig
